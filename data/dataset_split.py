...
# 设置数据集目录和目标划分目录
data_dir = "C:/Users/13154/Downloads/Documents/YOLOv5/data/PlantVillage"  # 原始数据集目录
output_dir = "C:/Users/13154/Downloads/Documents/YOLOv5/data/TrainPlantVillage"  # 输出数据集目录
